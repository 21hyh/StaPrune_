...
def eval_model(args):
    ...
    for line in question_bar:
        ...
        with torch.inference_mode():
            ...
            # Use default visual token number (576 for base, or visual_token_num if specified)
            v_token_num = args.visual_token_num if args.visual_token_num is not None else 576
